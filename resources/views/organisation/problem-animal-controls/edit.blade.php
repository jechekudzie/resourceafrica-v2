...
@section('title', 'Edit Problem Animal Control Record')
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div>
            <h1 class="h3 mb-0">Edit Problem Animal Control Record</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('organisation.problem-animal-controls.update', [$organisation->slug, $problemAnimalControl]) }}" method="POST">
                @csrf
                @method('PATCH')
                        ...
                        <select name="wildlife_conflict_incident_id" id="wildlife_conflict_incident_id" class="form-select select2 @error('wildlife_conflict_incident_id') is-invalid @enderror">
                            ...
                            @foreach($wildlifeConflictIncidents as $incident)
                                <option value="{{ $incident->id }}" 
                                    {{ (old('wildlife_conflict_incident_id', $problemAnimalControl->wildlife_conflict_incident_id) == $incident->id) ? 'selected' : '' }}
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control datepicker @error('control_date') is-invalid @enderror" id="control_date" name="control_date" value="{{ old('control_date', $problemAnimalControl->control_date->format('Y-m-d')) }}" placeholder="YYYY-MM-DD">
                        @error('control_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control timepicker @error('control_time') is-invalid @enderror" id="control_time" name="control_time" value="{{ old('control_time', $problemAnimalControl->control_time ? $problemAnimalControl->control_time->format('H:i') : '') }}" placeholder="HH:MM">
                        @error('control_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('period') is-invalid @enderror" id="period" name="period" value="{{ old('period', $problemAnimalControl->period) }}" min="1900" max="{{ date('Y') }}">
                        @error('period')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location', $problemAnimalControl->location) }}" placeholder="Enter location">
                        @error('location')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude', $problemAnimalControl->latitude) }}" placeholder="Enter latitude">
                        @error('latitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{ old('longitude', $problemAnimalControl->longitude) }}" placeholder="Enter longitude">
                        @error('longitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="number" class="form-control @error('estimated_number') is-invalid @enderror" id="estimated_number" name="estimated_number" value="{{ old('estimated_number', $problemAnimalControl->estimated_number) }}" min="1">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Enter additional details about the control activities">{{ old('description', $problemAnimalControl->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div class="control-measures-list">
                                @foreach($controlMeasures as $measure)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="control_measures[]" value="{{ $measure->id }}" id="measure_{{ $measure->id }}" 
                                            {{ in_array($measure->id, old('control_measures', $problemAnimalControl->controlMeasures->pluck('id')->toArray())) ? 'checked' : '' }}>
...
<script>
    $(document).ready(function() {
        ...
        // Trigger change event to update the form on page load
