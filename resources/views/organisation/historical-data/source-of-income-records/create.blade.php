...
@section('title')
Regional CBNRM - {{ $organisation->name }} - Add Source of Income Record
@endsection
...
<div class="card">
    <div class="card-header bg-white">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0">
                    <i class="fas fa-money-bill-wave me-1 text-primary"></i>Add Source of Income Record
                </h5>
                <p class="mb-0 text-muted small">Add a new source of income record for {{ $organisation->name }}</p>
            </div>
            <div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('source_of_income_records.store', $organisation->slug) }}" method="POST">
            @csrf
            <div class="row g-4">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('trophy_fee_amount') is-invalid @enderror" id="trophy_fee_amount" name="trophy_fee_amount" placeholder="0.00" value="{{ old('trophy_fee_amount', 0) }}" min="0" step="0.01" required>
                                        </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control @error('hides_amount') is-invalid @enderror" id="hides_amount" name="hides_amount" placeholder="0.00" value="{{ old('hides_amount', 0) }}" min="0" step="0.01" required>
                                        </div>
                                        @error('hides_amount')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control @error('meat_amount') is-invalid @enderror" id="meat_amount" name="meat_amount" placeholder="0.00" value="{{ old('meat_amount', 0) }}" min="0" step="0.01" required>
                                        </div>
                                        @error('meat_amount')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control @error('hunting_concession_fee_amount') is-invalid @enderror" id="hunting_concession_fee_amount" name="hunting_concession_fee_amount" placeholder="0.00" value="{{ old('hunting_concession_fee_amount', 0) }}" min="0" step="0.01" required>
                                        </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control @error('photographic_fee_amount') is-invalid @enderror" id="photographic_fee_amount" name="photographic_fee_amount" placeholder="0.00" value="{{ old('photographic_fee_amount', 0) }}" min="0" step="0.01" required>
                                        </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('other_description') is-invalid @enderror" id="other_description" name="other_description" rows="3" placeholder="Describe other income sources...">{{ old('other_description') }}</textarea>
                ...
                <div class="col-12 mt-4">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i>Save Source of Income Record
                        </button>
                    </div>
                </div>
            </div>
