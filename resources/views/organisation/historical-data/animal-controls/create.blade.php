...
@section('title')
Regional CBNRM - {{ $organisation->name }} - Add Animal Control Record
@endsection
...
<div class="card">
    <div class="card-header bg-white">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0">
                    <i class="fas fa-paw me-1 text-primary"></i>Add Animal Control Record
                </h5>
                <p class="mb-0 text-muted small">Record historical animal control operations</p>
            </div>
            <div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('animal_control_records.store', $organisation->slug) }}" method="POST">
            @csrf
            <div class="row g-4">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="number_of_cases" id="number_of_cases" class="form-control @error('number_of_cases') is-invalid @enderror" 
                            value="{{ old('number_of_cases', 0) }}" min="0" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="killed" id="killed" class="form-control @error('killed') is-invalid @enderror" 
                            value="{{ old('killed', 0) }}" min="0" required>
                        @error('killed')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="relocated" id="relocated" class="form-control @error('relocated') is-invalid @enderror" 
                            value="{{ old('relocated', 0) }}" min="0" required>
                        @error('relocated')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="scared" id="scared" class="form-control @error('scared') is-invalid @enderror" 
                            value="{{ old('scared', 0) }}" min="0" required>
                        @error('scared')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
