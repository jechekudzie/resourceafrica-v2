...
@section('title')
    Regional CBNRM - {{ $organisation->name }} - Add Human Resource Record
@endsection
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select name="employed_by" id="employed_by" class="form-select @error('employed_by') is-invalid @enderror" required>
                                    <option value="community" {{ old('employed_by') == 'community' ? 'selected' : '' }}>Community</option>
                                    <option value="organisation" {{ old('employed_by', 'organisation') == 'organisation' ? 'selected' : '' }}>{{ $organisation->name }}</option>
                                </select>
                                @error('employed_by')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="wildlife_managers" id="wildlife_managers" class="form-control @error('wildlife_managers') is-invalid @enderror" value="{{ old('wildlife_managers', 0) }}" min="0" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="game_scouts" id="game_scouts" class="form-control @error('game_scouts') is-invalid @enderror" value="{{ old('game_scouts', 0) }}" min="0" required>
                                @error('game_scouts')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="rangers" id="rangers" class="form-control @error('rangers') is-invalid @enderror" value="{{ old('rangers', 0) }}" min="0" required>
                                @error('rangers')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
