...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var adminAmount = {{ $incomeUseRecord->administration_amount }};
        var managementAmount = {{ $incomeUseRecord->management_activities_amount }};
        var socialAmount = {{ $incomeUseRecord->social_services_amount }};
        var lawAmount = {{ $incomeUseRecord->law_enforcement_amount }};
        var otherAmount = {{ $incomeUseRecord->other_amount }};
        
        // Get the canvas element
        var ctx = document.getElementById('incomeUseChart');
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [adminAmount, managementAmount, socialAmount, lawAmount, otherAmount],
