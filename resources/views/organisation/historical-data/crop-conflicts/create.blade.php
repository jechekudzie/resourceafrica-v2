...
@section('title')
Regional CBNRM - {{ $organisation->name }} - Add Crop Conflict Record
@endsection
...
<div class="card mb-3">
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">
                    <i class="fas fa-plus-circle me-2 text-primary"></i>Add New Crop Conflict Record
                </h5>
                <p class="mb-0 text-muted small">Add historical crop damage data from wildlife conflicts</p>
            </div>
            <div class="col-auto align-self-center">
    ...
    <div class="card-body bg-light">
        ...
        <form action="{{ route('crop_conflict_records.store', $organisation->slug) }}" method="POST">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('crop_type_id') is-invalid @enderror" 
                        ...
                        @foreach($cropTypes as $cropType)
                            <option value="{{ $cropType->id }}" {{ old('crop_type_id') == $cropType->id ? 'selected' : '' }}>
                                {{ $cropType->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('hectrage_destroyed', 0) }}"
                           min="0"
                           step="0.01"
                           required>
