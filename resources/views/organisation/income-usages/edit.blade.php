...
@section('title', 'Edit Income Usage')
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 mb-0">Edit Income Usage</h1>
    ...
    <div class="card">
        <div class="card-header">
            ...
            Edit Income Usage Record
        </div>
        <div class="card-body">
            <form action="{{ route('organisation.income-usages.update', [$organisation, $incomeUsage]) }}" method="POST">
                @csrf
                @method('PATCH')
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @error('period') is-invalid @enderror" 
                            ...
                            @foreach(range(date('Y'), 2019) as $year)
                                <option value="{{ $year }}" {{ old('period', $incomeUsage->period) == $year ? 'selected' : '' }}>
                                    {{ $year }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @error('month') is-invalid @enderror" 
                            ...
                            @foreach(range(1, 12) as $month)
                                <option value="{{ $month }}" {{ old('month', $incomeUsage->month) == $month ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('administration_amount', $incomeUsage->administration_amount) }}" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('management_activities_amount', $incomeUsage->management_activities_amount) }}" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('social_services_amount', $incomeUsage->social_services_amount) }}" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('law_enforcement_amount', $incomeUsage->law_enforcement_amount) }}" required>
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('other_amount', $incomeUsage->other_amount) }}" required>
                        </div>
                        @error('other_amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('other_description') is-invalid @enderror" 
                               ...
                               value="{{ old('other_description', $incomeUsage->other_description) }}" 
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save me-1"></i> Update Income Usage
                    </button>
                </div>
            </form>
        </div>
