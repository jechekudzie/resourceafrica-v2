...
@section('title', 'Edit Client Source')
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 mb-0">Edit Client Source</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('organisation.client-sources.update', [$organisation, $clientSource]) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('period') is-invalid @enderror" id="period" name="period" required>
                                ...
                                @for($year = $startYear; $year <= $endYear; $year++)
                                    <option value="{{ $year }}" {{ old('period', $clientSource->period) == $year ? 'selected' : '' }}>
                                        {{ $year }}
                                    </option>
                                @endfor
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('month') is-invalid @enderror" id="month" name="month" required>
                                @foreach(range(1, 12) as $month)
                                    <option value="{{ $month }}" {{ old('month', $clientSource->month) == $month ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('north_america') is-invalid @enderror" 
                                   ...
                                   value="{{ old('north_america', $clientSource->north_america) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('europe_asia') is-invalid @enderror" 
                                   ...
                                   value="{{ old('europe_asia', $clientSource->europe_asia) }}" 
                                   min="0" step="1" required>
                            @error('europe_asia')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('africa') is-invalid @enderror" 
                                   ...
                                   value="{{ old('africa', $clientSource->africa) }}" 
                                   min="0" step="1" required>
                            @error('africa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('asia') is-invalid @enderror" 
                                   id="asia" name="asia" 
                                   value="{{ old('asia', $clientSource->asia) }}" 
                                   min="0" step="1" required>
                            @error('asia')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('middle_east') is-invalid @enderror" 
                                   ...
                                   value="{{ old('middle_east', $clientSource->middle_east) }}" 
                                   min="0" step="1" required>
                            @error('middle_east')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('south_america') is-invalid @enderror" 
                                   ...
                                   value="{{ old('south_america', $clientSource->south_america) }}" 
                                   min="0" step="1" required>
                            @error('south_america')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('oceania') is-invalid @enderror" 
                                   ...
                                   value="{{ old('oceania', $clientSource->oceania) }}" 
                                   min="0" step="1" required>
                            @error('oceania')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
