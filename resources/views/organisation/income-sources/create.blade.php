...
<div class="container-fluid px-4">
    <h1 class="mt-4">Add Income Source</h1>
    <div class="card mb-4">
        <div class="card-header">
            <i class="fas fa-plus me-1"></i>
            New Income Source Record
        </div>
        <div class="card-body">
            <form action="{{ route('organisation.income-sources.store', $organisation) }}" method="POST">
                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('period') is-invalid @enderror" 
                                ...
                                @foreach($years as $year)
                                    <option value="{{ $year }}" {{ old('period', $currentYear) == $year ? 'selected' : '' }}>
                                        {{ $year }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('trophy_fee_amount', '0.00') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('hides_amount', '0.00') }}" required>
                            @error('hides_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('meat_amount', '0.00') }}" required>
                            @error('meat_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('hunting_concession_fee_amount', '0.00') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0" 
                                   ...
                                   value="{{ old('photographic_fee_amount', '0.00') }}" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control @error('other_description') is-invalid @enderror" 
                              id="other_description" name="other_description" rows="3">{{ old('other_description') }}</textarea>
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-primary">Save Income Source</button>
