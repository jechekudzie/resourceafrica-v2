    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('species.update', [$organisation->slug ?? '', $species]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                                   id="name" name="name" value="{{ old('name', $species->name) }}" required>
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('scientific') is-invalid @enderror" 
                                                   id="scientific" name="scientific" value="{{ old('scientific', $species->scientific) }}">
                                            @error('scientific')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('male_name') is-invalid @enderror" 
                                                   id="male_name" name="male_name" value="{{ old('male_name', $species->male_name) }}">
                                            @error('male_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('female_name') is-invalid @enderror" 
                                                   id="female_name" name="female_name" value="{{ old('female_name', $species->female_name) }}">
                                            @error('female_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mt-2">
                                                <img id="avatar-preview" 
                                                     src="{{ $species->avatar ? asset($species->avatar) : asset('images/default-species.jpg') }}" 
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="is_special" 
                                                       name="is_special" value="1" {{ old('is_special', $species->is_special) ? 'checked' : '' }}>
