                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                        <li class="nav-item">
                            ...
                            <div class="nav-item-wrapper">
                                <a class="nav-link dropdown-indicator label-1" href="#nv-home" role="button" data-bs-toggle="collapse"
                                    aria-expanded="{{ Request::routeIs('admin.organisation-types.*') || Request::routeIs('admin.organisations.*') ? 'true' : 'false' }}"
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent {{ Request::routeIs('admin.organisation-types.*') || Request::routeIs('admin.organisations.*') ? 'show' : '' }}"
                                        data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                                       <!--  <li class="nav-item">
                                            <a class="nav-link {{ Request::routeIs('admin.organisation-types.index') ? 'active' : '' }}"
                                                href="{{ route('admin.organisation-types.index') }}">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Zanu PF Party Structure</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::routeIs('admin.organisations.index') ? 'active' : '' }}"
                                                href="{{ route('admin.organisations.index') }}">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Zanu PF Party Organisations</span>
                                                </div>
                                            </a>
                                        </li> -->

                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::routeIs('admin.organisation-types.manage') ? 'active' : '' }}"
                                                href="{{ route('admin.organisation-types.manage') }}">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Manage Organisation Types</span>
                                                </div>
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Request::routeIs('admin.organisations.manage') ? 'active' : '' }}"
                                                href="{{ route('admin.organisations.manage') }}">
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Manage Organisations</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link  {{ Request::routeIs('admin.permissions.index') ? 'active' : '' }}" href="{{route('admin.permissions.index')}}" >
                                                <div class="d-flex align-items-center">
                                                    <span class="nav-link-text">Modules & Permissions</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="nav-item-wrapper">
                                <a class="nav-link dropdown-indicator label-1" href="#admin" role="button" data-bs-toggle="collapse"
                                    aria-expanded="false"
                                    aria-controls="admin">
                                    <div class="d-flex align-items-center">
                                        <div class="dropdown-indicator-icon">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent"
                                        data-bs-parent="#navbarVerticalCollapse" id="admin">
                                        <li class="nav-item">
        ...
        <nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav navbar-nav-icons flex-row">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('organisation.dashboard') }}" class="nav-link" title="Back to Organisation Dashboard">
                            <span class="d-none d-sm-inline-block me-1">Organisations</span>
